...
public class UserScoreDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		job1.setJarByClass(UserScoreDriver.class);
		job1.setMapperClass(UserScoreMapper.class);
		job1.setReducerClass(UserScoreReducer.class);
